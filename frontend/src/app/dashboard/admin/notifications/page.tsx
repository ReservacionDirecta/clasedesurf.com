      ...
      <div className="space-y-4">
        {notifications.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-xl border border-slate-100">
            ...
            <p className="text-slate-500">Aquí verás alertas del sistema y mensajes importantes.</p>
          </div>
        ) : (
          notifications.map((notification) => (
            <Link 
              ...
              className={`block bg-white p-4 rounded-xl border transition-all hover:shadow-md ${
                notification.isRead ? 'border-slate-100' : 'border-purple-200 bg-purple-50/30'
              }`}
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-sm text-purple-600 font-medium">Ver detalles &rarr;</span>
                  </div>
                </div>
              </div>
            </Link>
