...
export default function InstructorProfilePage() {
  ...
  useEffect(() => {
    ...
    if (!session || !(session as any).user || (session as any).user.role !== 'INSTRUCTOR') {
      router.push('/denied');
      return;
    }
    ...
    const fetchInstructor = async () => {
      ...
      try {
        ...
        const res = await fetch(`${BACKEND}/users/profile`, { headers });
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">My Classes</h2>
