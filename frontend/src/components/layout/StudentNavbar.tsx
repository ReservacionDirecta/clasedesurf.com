...
export function StudentNavbar() {
  ...
  const navigation = [
    { name: 'Mi Perfil', href: '/dashboard/student/profile', icon: '👤' },
    { name: 'Mis Reservas', href: '/reservations', icon: '📅' },
    { name: 'Clases Disponibles', href: '/classes', icon: '🏄' },
    { name: 'Inicio', href: '/', icon: '🏠' },
  ];

  const isActive = (href: string) => {
    if (href === '/dashboard/student/profile') {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/dashboard/student/profile" className="flex items-center space-x-3">
